...
const API_ENDPOINT = process.env.API_ENDPOINT || "http://localhost:8080/api/media/upload";

const mapping = {}; // filename → url
...
const main = async () => {
  ...
  console.log(`📁 Saved ${Object.keys(mapping).length} image URLs to seed/images.json`);
};
